...
if comlin_args == 0:
	print()
	function=input("what task are you trying to do? database_backup, backup_f_d, disk_utilization_check, G_zipp or unzipp?: ")
	...
	if function == "database_backup":
		...
		print()
		print("USAGE: the following is how to properly use the database_backup, backup_f_d, disk_utilization_check, G_zipp and unzipp function!")
		print()
