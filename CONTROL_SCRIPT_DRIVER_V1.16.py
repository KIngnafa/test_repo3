...
#imported modules
import sys
import stack_modules_v16cp as k
import getpass as w
...
if comlin_args == 0:
	...
	if comlin_args == 9:
		...
		print()
		print("       disk_utilization_check")
		print("       eg .modulename disk_utilization_check disk threshold schema_pass runner dbname user DSN")
		print()
	...
	if comlin_args == 11:
		...
		print()
		print("       database_import")
		print("       eg .modulename database_import schema directory par_dir sourcedb_physical dbname import_schema dmp_file schema_pass user DSN")
		print()
	...
	if comlin_args == 13:
		...
		k.data_migration(user=user,DSN=DSN,schema_pass=schema_pass,schema=schema,runner=runner,directory=directory,sourcedb_physical=sourcedb_physical,par_dir=par_dir,importdb_physical=importdb_physical,source_dbname=source_dbname,target_dbname=target_dbname,import_schema=import_schema)
			

	elif comlin_args != 13:
		print()
		print("Incorrect arguments")
		print("USAGE: the following is how to properly use the data_migration function!")
		print()
		print("       data_migration")
		print("       eg .modulename data_migration schema runner directory par_dir sourcedb_physical ,importdb_physical source_dbname target_dbname import_schema schema_pass user DSN")
		print()
	...
	print()
	print("       disk_utilization_check")
	print("       eg .modulename disk_utilization_check disk threshold schema_pass schema runner dbname user DSN")
	print()
	print("       G_zipp")
